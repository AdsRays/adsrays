...
Ты ничего не теряешь. А обрести можешь многое.`
  ...
  return (
    <>
      <div className="p-6">
        <Tabs defaultValue="upload-analysis" value={selectedTab} onValueChange={setSelectedTab}>
        ...
        <div className="mt-8">
          <Button onClick={handleAIResponse}>Получить совет</Button>
          <p className="mt-4 whitespace-pre-wrap text-sm text-gray-800">{aiAnswer}</p>
        </div>
      </div>
    </>
  );
